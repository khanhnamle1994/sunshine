...
import static com.example.android.data.data.TestUtilities.getConstantNameByStringValue;
import static com.example.android.data.data.TestUtilities.getStaticIntegerField;
import static com.example.android.data.data.TestUtilities.getStaticStringField;
import static com.example.android.data.data.TestUtilities.studentReadableClassNotFound;
...
public class TestSunshineDatabase {
    ...
    public void testDuplicateDateInsertBehaviorShouldReplace() {
        ...
        ContentValues testWeatherValues = com.example.android.data.data.TestUtilities.createTestWeatherContentValues();
    ...
    public void testNullColumnConstraints() {
        ...
        ContentValues testValues = com.example.android.data.data.TestUtilities.createTestWeatherContentValues();
...
//        tableNameHashSet.add(MyOtherCoolTableNameThatContainsOtherCoolData);
    ...
    public void testInsertSingleRecordIntoWeatherTable() {
        ...
        com.example.android.data.data.TestUtilities.validateCurrentRecord(expectedWeatherDidntMatchActual,
                weatherCursor,
                testWeatherValues);
